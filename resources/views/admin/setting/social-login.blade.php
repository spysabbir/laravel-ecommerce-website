...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('social-login.setting.update', $social_login_setting->id)}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="m-3">
                        <button class="btn btn-info" type="submit">Update Social Login Setting</button>
                    </div>
                </form>
            </div>
        </div>
