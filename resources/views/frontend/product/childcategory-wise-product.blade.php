                ...
                <div class="breadcrumb__wrapper">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ $childcategory->childcategory_name }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="product-lists-top">
                    <div class="product__filter-wrap">
                        <div class="row align-items-center justify-content-end">
                            ...
                            <input type="hidden" value="{{ $childcategory->id }}" class="form-control filter_data" id="childcategory_id" name="childcategory_id">
